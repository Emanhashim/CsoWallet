...
public class LoginService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        CsoWalletModel registerUser = loginRepository.findByUsername(email).get();
    ...
    public ResponseEntity<?> LoginUser(UserDetails username, String jwt) {
        CsoWalletModel registerUser = loginRepository.findByUsername(username.getUsername()).get();
