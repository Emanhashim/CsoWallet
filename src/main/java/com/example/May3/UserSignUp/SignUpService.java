...
//   this is default method while implementing userdetail service
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        CsoWalletModel registerUser = signUpRepository.findByUsername(email).get();
...
//this is the signup function alone
    ...
    public ResponseEntity<?> signUp(CsoWalletModel registerUser, String passCode) {
        ...
        CsoWalletModel user = signUpRepository.findByUsername(registerUser.getUsername()).get();
